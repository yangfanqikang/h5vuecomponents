<template>
  <page :title="this.$route.query.name" class="demo-list">
    <h4>基本用法</h4>
    <div>
      <nut-cell>
    ...
    <div>
      <nut-cell>
        <span slot="title"><nut-checkboxgroup :size="'small'" :checkBoxData="data3"
                                              v-model="group3"></nut-checkboxgroup></span>
      ...
      <nut-cell>
        <span slot="title"><nut-checkboxgroup :checkBoxData="data33" :size="'small'"
                                              v-model="group5"></nut-checkboxgroup></span>
    ...
    <div>
      <nut-cell>
        <span slot="title"><nut-checkboxgroup :checkBoxData="['选项1','选项2']" v-model="group6"
                                              :animation="false"></nut-checkboxgroup></span>
    ...
    <div>
      <nut-cell>
        <span slot="title"><nut-checkboxgroup :checkBoxData="data5" v-model="group7"
                                              :vertical="true"></nut-checkboxgroup></span>
      </nut-cell>
    ...
    <div>
      <nut-cell>
        <span slot="title"><nut-checkboxgroup :checkBoxData="data6" v-model="group0"
                                              @change="changeEvt"></nut-checkboxgroup></span>
      </nut-cell>
      <p>选择状态：{{group0}}</p>
    ...
    <div>
      <nut-cell>
        <span slot="title"><nut-checkboxgroup :customClass="'my-checkbox'" :checkBoxData="data7"
                                              v-model="group8"></nut-checkboxgroup></span>
      </nut-cell>
