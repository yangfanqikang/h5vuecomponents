<template>
  <div class="demo-list">
    ...
    <div>
      <nut-cell>
        <span slot="title">
          <nut-stepper @focus="focus" :blur="blur" :value.sync="val1" :max="12" :step="0.1" :decimalPlaces="1"
                       @add="add"></nut-stepper>
        </span>
        <span slot="desc">
          value: {{val1}} <button @click="reduce" class="demo-btn">-</button> <button @click="add"
