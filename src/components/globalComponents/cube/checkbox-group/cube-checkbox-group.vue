...
import CubeCheckbox from '../checkbox/cube-checkbox.vue'
import groupCol from '../../../../mixins/cube/mixins/group-col'
...
<style lang="stylus" rel="stylesheet/stylus">
  @require "~@/style/stylus/variable.styl"
  @require "~@/style/stylus/mixin.styl"
