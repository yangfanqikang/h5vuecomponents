<template>
  <div class="uni-numbox">
    <div @click="_calcValue('minus')" class="uni-numbox__minus">
      <p :class="{ 'uni-numbox--disabled': inputValue <= min || disabled }" class="uni-numbox--text">-</p>
    </div>
    ...
    <div @click="_calcValue('plus')" class="uni-numbox__plus">
      <p :class="{ 'uni-numbox--disabled': inputValue >= max || disabled }" class="uni-numbox--text">+</p>
    </div>
  </div>
</template>
<script>
